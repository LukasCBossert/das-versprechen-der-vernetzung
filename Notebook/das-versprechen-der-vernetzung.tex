...
\PY{c+c1}{\PYZsh{}install.packages(\PYZsq{}igraph\PYZsq{})}
...
Die Daten selbst kommen von dem GitHub-Gist
...
wir mit \texttt{frame=TRUE} einen Rahmen um das Netzwerk haben wollen.
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{set.seed}\PY{p}{(}\PY{l+m}{987654}\PY{p}{)}
...
\texttt{layout}.
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{set.seed}\PY{p}{(}\PY{l+m}{98765}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_20_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_24_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_30_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_34_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Nummer aus der NFDI-\emph{Konferenz}systematik. In der dritten Spalte
steht die Runde, in der das Konsortium bewillgt wurde: \texttt{1}= 2019,
\texttt{2}= 2020. Die Daten können aus dem öffentlichen GitHub-Gist
...
\end{tcolorbox}
    ...
    \hypertarget{dfgnfdi-farbkodierung}{%
\subsection{DFG/NFDI-Farbkodierung}\label{dfgnfdi-farbkodierung}}
...
\midrule
\endhead
(1) & Medizin & \texttt{\#f5ac9f} \\
(2) & Lebenswissenschaften & \texttt{\#e43516} \\
(3) & Geisteswissenschaften & \texttt{\#f9b900} \\
(4) & Ingenieurwissenschaften & \texttt{\#007aaf} \\
(5) & Chemie/Physik & \texttt{\#6ca11d} \\
\bottomrule
\end{longtable}
...
we make it as a function.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{nfdi\PYZus{}plot\PYZus{}legend} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{p}{)}\PY{p}{\PYZob{}}
    
    \PY{n+nf}{legend}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{bottomleft\PYZdq{}}\PY{p}{,}   \PY{c+c1}{\PYZsh{} x\PYZhy{}position}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_51_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{c+c1}{\PYZsh{} pdf(paste0(\PYZdq{}img/network\PYZus{}group\PYZus{}\PYZdq{},NFDI\PYZus{}name,\PYZdq{}.pdf\PYZdq{}))   }
\PY{c+c1}{\PYZsh{} nfdi\PYZus{}local\PYZus{}network(NFDI\PYZus{}name)}
\PY{c+c1}{\PYZsh{} dev.off()}
 \PY{n+nf}{nfdi\PYZus{}local\PYZus{}network}\PY{p}{(}\PY{n}{NFDI\PYZus{}name}\PY{p}{)}
\PY{p}{\PYZcb{}}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_53_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_54_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_3.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_4.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_5.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_6.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_7.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_8.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_9.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_10.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_11.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_12.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_13.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_14.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_15.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_16.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_17.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{das-versprechen-der-vernetzung_files/das-versprechen-der-vernetzung_56_18.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \hypertarget{sicherung-export-und-ausblick}{%
\section{Sicherung, Export und
Ausblick}\label{sicherung-export-und-ausblick}}
